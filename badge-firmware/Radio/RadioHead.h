...
#define RH_PLATFORM_STM32F1_HAL			14
...
// Select platform automatically, if possible
  ...
  #define RH_PLATFORM RH_PLATFORM_UNIX
#elif defined(STM32F1_HAL)
	#define RH_PLATFORM RH_PLATFORM_STM32F1_HAL
 #else
...
#elif (RH_PLATFORM == RH_PLATFORM_STM32F1_HAL) //@cmdc0de support for f1's over HAL using uVision or system workbench
 #include <stm32f1xx.h>
 #define millis HAL_GetTick
 #define PROGMEM 
 #define digitalWrite(a,b) //HAL_GPIO_WritePin(SPI_NSS_GPIO_Port,SPI_NSS_Pin,GPIO_PinState(b));
 #define LOW 0
 #define HIGH 1
 #define pinMode(a,b)
 #define memcpy_P memcpy
...
// See http://arduino.cc/en/Reference/attachInterrupt
 ...
 #elif (RH_PLATFORM == RH_PLATFORM_STM32F1_HAL) 
 #define digitalPinToInterrupt(p) ((p) == GPIO_PIN_3 ? 0 : 1)
 #else
